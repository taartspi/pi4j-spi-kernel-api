...
# **********************************************************************
# ORGANIZATION  :  Pi4J
# PROJECT       :  Pi4J :: JNI Native Binding Library for SPIapi
# FILENAME      :  build.sh
#
...
echo "**********************************************************************"
echo "*                                                                    *"
echo "*            Pi4J SPIapi LIBRARY NATIVE BUILD <STARTED>              *"
echo "*                                                                    *"
echo "**********************************************************************"
echo
...
echo "======================================"
echo " Pi4J SPIapi LIBRARY NATIVE ARTIFACTS "
echo "======================================"
tree -R lib
...
echo "**********************************************************************"
echo "*                                                                    *"
echo "*           Pi4J SPIapi LIBRARY NATIVE BUILD <FINISHED>              *"
echo "*                                                                    *"
echo "**********************************************************************"
echo